...
| Target | Signals |
|---|---|
| Website | the front page **and up to 5 linked pages**: density of 67 stock AI-marketing phrases, live placeholder content (lorem ipsum, "Your Company"), default template leftovers, AI site-builder fingerprints in the markup (Lovable, v0, Bolt.new, Framer, Wix, Durable, 10Web, Hostinger AI, Base44). Generator defaults left in the page head ("Vite + React + TS", "Lovable Generated Project"). Also measures **Looks Shipped** signs of a finished product (content pages, specific facts, finished metadata, trust pages, extra craft). Sites under 100 words with no unambiguous sign are reported as **not assessable**; the stock-phrase check needs 150 words |
